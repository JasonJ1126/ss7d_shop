      ...
      <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
          <div class="site-heading">
            <h1>产品更改</h1>
            s<form action="${pageContext.request.contextPath }/admin/toAdd" method="post">
               书籍名:<input name="bookName" class="form-control" type="text">
      </br></br>
               书籍价格: <input name="bookPrice" class="form-control" type="text">
      </br></br>
               书籍数量: <input name="bookNumber" class="form-control" type="text">
      </br></br>
