			...
			<div class="row">
				<div class="col-lg-8 col-md-10 mx-auto">
					<div class="site-heading">
						<h1>产品添加</h1>
						s
						<form action="${pageContext.request.contextPath }/admin/todeleteSuccess"
							method="post">
							书籍ID:<input name="bookName" class="form-control" type="text">
							</br>
							
							</br> <input type="submit" class="btn btn-primary" value="确认删除">
					</div>
				</div>
			</div>
		</div>
