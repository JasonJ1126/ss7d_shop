...
<!-- 								<column> <facet name="productName"> 书籍名称 <facet></column> -->
<!-- 								<column> <facet name="productprice"> 书籍价格 <facet></column> -->
<!-- 								<column> <facet name="productNumber"> 书籍数量 <facet></column> -->
<!-- 								<column> <facet name="productId"> 书籍ID <facet></column> -->
